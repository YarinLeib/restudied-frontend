...
export function ItemListPage() {
  ...
  const filteredItems = items.filter((item) => {
    const matchesTitle = item.title.toLowerCase().includes(filterText.toLowerCase());
    const matchesCategory = filterCategory ? item.itemCategory.includes(filterCategory) : true;
